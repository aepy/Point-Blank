...
char *MoptRep_Item      []  = {"Off", "Soccer Granade","Candy Granade","Lantern Grenade"}; 
char *MoptReplace       [] = {"Off", "Famas Launcher","K-201 Exit","AK 47 FC","AK Sopmod R","SCAR D","RPG-7"};
...
RenderContext *pRC	= (RenderContext*)(dwGFX + 0x1B2270);
//------------------------------------------------------------------------------------
class RenderData {
public:
char unknown0[0x20];
...
{
DWORD dwRenderData = (DWORD)GetModuleHandleA("i3GfxDx.dll") + 0x1A0610;
...
DWORD PlayerIndexB = *(DWORD*)(PlayerIndexA + 0x560);
