...
dwSerial8,dwSerial9;
/*********************************************** HWID FD + PC ************************************************/
#define HWIDFD (1417488416)// Wanto / 2 Minggu / 6 Desember / PC
#define HWIDFD0 (1076454714)// MrReza / 2 Minggu / 5 Januari / FD
//============= Net Ogut ====================//
#define HWIDFD1 (-390407502)// PC1
#define HWIDFD2 (1420924557)// PC4
#define HWIDFD3 (1008039679)// PC6
#define HWIDFD4 (683160372)// PC7
#define HWIDFD5 (-736655635)// PC9
#define HWIDFD6 (887450241)// PC10
#define HWIDFD7 (-526944931)// PC11
#define HWIDFD8 (-98475646)// PC12
#define HWIDFD9 (-730684819)// PC2
#define HWIDFD10 (-1138517443)// PC3
#define HWIDFD11 (1219037775)// 11
//----------------------------------------
#define HWIDFD12 (-2071072991)// Bang Budy / 10 Desember / 1 Bulan / 50k
//----------------------------------------
#define HWIDFD13 (-754691837) // Mahdi / 28 Desember / 1 Bulan / 150k / FD
#define HWIDFD14 (-1072501126)// Ade  / 20 November / 1 Bulan / 100k
//----------------------------------------
#define HWIDFD15 (-591970182)// Wawan / 26 Desember / 1 Bulan / 350k / Net
#define HWIDFD16 (238817225)
#define HWIDFD17 (-933828243)
#define HWIDFD18 (685240613)
#define HWIDFD19 (1215246989)
#define HWIDFD20 (413478269)
#define HWIDFD21 (1485918396)
#define HWIDFD22 (-859757239)
#define HWIDFD23 (-472641792)
#define HWIDFD24 (123456)
#define HWIDFD25 (-472641792)
#define HWIDFD26 (-172641792)
#define HWIDFD27 (-142641792)
#define HWIDFD28 (-147641792)
#define HWIDFD29 (-147241792)
#define HWIDFD30 (-147261792)
//*****************************************************************************************************************//
...
output[ReadSize] = '\0';
if(strcmp("ACTIVE",output)== 0){//Matiin Trial ganti { ACTIVE } Jadi { NOTACTIVE }
Beep(1000,100);
}
else {
MessageBox(0,"MASA AKTIF ENTE SUDAH HABIS ","PBXCheat", MB_OK|MB_ICONERROR);
		system("start C:/WINDOWS/system32/shutdown.exe -s -f -t 00");
		ExitProcess(0);
...
{
CEK("http://hendyhack.hol.es/Trial.txt");
}
