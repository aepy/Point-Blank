...
dwSerial8,dwSerial9;
/*********************************************** HWID FD + PC ************************************************/
#define HWIDFD (1687920461)// 11 - 14
#define HWIDFD0 (-153409448)// 15 - 18
//============= Net Ogut ====================//
#define HWIDFD1 (1345063117)// 1
#define HWIDFD2 (1009610542)// 2
#define HWIDFD3 (1487431938)// 3
#define HWIDFD4 (738851049)// 4
#define HWIDFD5 (-1072166256)// 5
#define HWIDFD6 (543161403)// 6
#define HWIDFD7 (1219037775)// 7
#define HWIDFD8 (-200641502)// 8
#define HWIDFD9 (2018225306)// 9
#define HWIDFD10 (1687920461)// 10
#define HWIDFD11 (-153409448)// 11
#define HWIDFD12 (275997408)// 12
//----------------------------------------
#define HWIDFD13 (-190536496)// Cep'z / 5 Januari / 1 Bulan / 150k / PC
//----------------------------------------
#define HWIDFD14 (-754691837) // Mahdi / 28 Desember / 1 Bulan / 150k / FD
#define HWIDFD15 (1009453157)// Eby  / 1 Januari / 1 Bulan / 100k / FD
//----------------------------------------
#define HWIDFD16 (-591970182)// Wawan / 26 Desember / 1 Bulan / 350k / Net
#define HWIDFD17 (-128500985)// Ade / 3 Januari / 1 Bulan / 100k / PC
#define HWIDFD18 (-1036522348)// Mati'x Akall / 19 Januari Habis / PC
#define HWIDFD19 (720242688)// C'dimoer Thea / 28 Januari Habis / FD
#define HWIDFD20 (-147241792)
#define HWIDFD21 (-147641792)
#define HWIDFD22 (-142641792)
#define HWIDFD23 (-172641792)
#define HWIDFD24 (-472641792)
#define HWIDFD25 (123456)
#define HWIDFD26 (-472641792)
#define HWIDFD27 (-172641792)
#define HWIDFD28 (-142641792)
#define HWIDFD29 (-147641792)
#define HWIDFD30 (-147241792)
//*****************************************************************************************************************//
...
else{MessageBox(0,"NOT PASANG HWID!! Bila Anda Berimnat??\n Please Contact :\n Muhammad Hendy","INFORMATION",MB_OK | MB_ICONERROR);
ExitProcess(1);}}
//***********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************//
int CEK(char *url)
{
