...
//-----------------------------------------------------------------------------
	enum I_COLORS{  // Item Colors
		C_OFF	 =	D3DCOLOR_ARGB(255,000,000,000),//ini warna pada nama fitur saat keadaan [OFF]
		C_ON	 =  D3DCOLOR_ARGB(255,255,192,203),//ini warna pada nama fitur saat keadaan [ON]
...
//-----------------------------------------------------------------------------
	enum BK_COLORS{ // BackGround Colors
		C_BOX    = D3DCOLOR_ARGB(100,255,000,000), //Box
		C_BOX2   = D3DCOLOR_ARGB(255,255,255,000), //Box
		C_BORDER = D3DCOLOR_ARGB(255,000,255,000) //Border
	};
