/*AutoLogger.h PBHacks Last Edit By Angga Reviza*/
...
LPTSTR SetStart			= "?SetStart@i3CollideeLine@@QAEXPATVEC3D@@@Z";
LPTSTR SetEnd			= "?SetEnd@i3CollideeLine@@QAEXPATVEC3D@@@Z";
LPTSTR Initialize		= "??0i3CollideeLine@@QAE@XZ";
LPTSTR RaycastClosest	= "?RaycastClosest@i3PhysixContext@@QAEPAU_tagi3PhysixHitResult@@PAVi3CollideeLine@@HI@Z";
LPTSTR Viewer			= "?g_pMainViewer@@3PAVi3Viewer@@A";
LPTSTR PBi3ScenDx		= "i3SceneDx.dll";

/*------------------------------------------- Declaration DWORD ------------------------------------------------------*/
DWORD DwStartAddress, DwStartGfx, DwStartScn, DwStartFmx, DwStartNxCha, DwSize, DwSizei3Fmx, DwSizeNxCha;
DWORD dwSetStart, dwSetEnd, dwInitialize, dwViewer, dwRaycastClosest;
...
DWORD DwPTRRecoil, DwPTRpTarget2, DwPTRCaclAmmo, DwPTRIdle, ResultPTRRecoil, DwmBone, DwStageInfo, DwBombArea, ResultmBone, ResultStageInfo, ResultBombArea, ResultPTRQC, ResultPTRWeapon, ResultPTRpTarget, ResultPTRpTarget2, ResultPTRCamPos, ResultPTRFShot, ResultPTRRapid, ResultPTRFall, ResultPTRRepeat, ResultPTRCaclAmmo, ResultPTRCaclKnife, ResultPTRIdle, ResultPTRIdle2;
...
DWORD DwVote, DwSuicide, DwBugUnyu, DwInvi, DwWallshoot, DwRange, DwMagnet, DwHover, ResultVote, ResultSuicide, ResultBugUnyu, ResultInvi, ResultWallshoot, ResultRange, ResultMagnet, ResultHover, ResultDatar;
DWORD DwSetNetChara, DwFakeReplace, DwDoLine, DwCamPos, DwEventFire, ResultSetNetChara, ResultFakeReplace, ResultDoLine, ResultCamPos, ResultEventFire;
...
//		 DwAsmBState      = (DWORD)GetProcAddress(GetModuleHandleA(PBi3Ipt), g_BState);
         dwSetStart		  = (DWORD)GetProcAddress(GetModuleHandleA(PBi3ScenDx), SetStart);
		 dwSetEnd		  = (DWORD)GetProcAddress(GetModuleHandleA(PBi3ScenDx), SetEnd);
		 dwInitialize     = (DWORD)GetProcAddress(GetModuleHandleA(PBi3ScenDx), Initialize);
		 dwRaycastClosest = (DWORD)GetProcAddress(GetModuleHandleA(PBi3ScenDx), RaycastClosest);
		 dwViewer	      = (DWORD)GetProcAddress(GetModuleHandleA(PBi3Fmxx), Viewer);
...
//		 DwSkillGM		  = FindPattern(DwStartAddress,DwSize,(PBYTE)Pattern_SkillGM,Mask_SkillGM);
		 ...
		 DwFakeReplace	  = FindPattern(DwStartAddress,DwSize,(PBYTE)Pattern_FakeReplace,Mask_FakeReplace);
...
/*------------------------------------------- Declaration Result ------------------------------------------------------*/
		 ...
		 ResultFakeReplace		= DwFakeReplace;
