...
//====================== Color Main.cpp =====================//
#define MCOLOR_TITLE    D3DCOLOR_RGBA(255, 255, 000, 255) // JUDUL
#define MCOLOR_CURRENT	D3DCOLOR_RGBA(255, 000, 000, 255) // ATAS BAWAH KIRI KANAN
#define MCOLOR_TEXT		D3DCOLOR_RGBA(000, 255, 000, 255) // TEXT 
#define MCOLOR_ACTIVE	D3DCOLOR_RGBA(000, 255, 000, 255) // ON
#define MENUCOLOR_TITLE	D3DCOLOR_RGBA(255, 255, 000, 255) // MENU
#define MCOLOR_FOLDER	D3DCOLOR_RGBA(255, 255, 000, 255) // FOLDER
#define MCOLOR_INACTIVE	D3DCOLOR_RGBA(255, 255, 255, 255) // OFF
