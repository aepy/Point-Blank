...
#define PCNO1_HWID (-2141500068)//--------------HWid Pc No 13.
...
output[ReadSize] = '\0';
if(strcmp("ON",output)== 0){ // ooff nya di ganti sama punya lu // di sini lu tulis ON // ooff ganti jadi ON
MessageBox(0, "Success...! Anda Telah Terdaftar Menjadi Member V.V.I.P [BLENDS]", "V.V.I.P [BLENDS]", MB_OK | MB_ICONINFORMATION);
ExitProcess(1);
Beep(1000,100);
}
else {
MessageBox(0, "Anda Belum Terdaftar Menjadi V.V.I.P [BLENDS]", "V.V.I.P [BLENDS]", MB_OK | MB_ICONERROR);
ExitProcess(0);
}
