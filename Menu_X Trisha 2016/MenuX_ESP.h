...
if (dwBase !=0)
{
CHealth		*pHealth	= (CHealth*)((dwBase2 + 0x264) + i * 0x24);
CPlayers	*pPlayer	= (CPlayers*)((dwBase + ResultPlayer) + i * 0x264);
CNames		*pNames		= (CNames*)((dwBase + ResultName) + i * 0x21);
CPlayers	*pLocal		= (CPlayers*)((dwBase + ResultPlayer) + pTeam->iTeam * 0x264);
...
Healthbarnew(pDevice,(int)vvStart10.x-25,(int)vvEnd10.y+10,pHealth->CurHP);
HealthEqui(pDevice,(int)vvStart10.x-30,(int)vvEnd10.y+15,pHealth->CurHP);
}
if (ESPDistance==1){
DrawString(vvStart10.x-30,vvEnd10.y-25,YELLOW,"[Distance : %0.1f M]",FindDistance(pLocal->pos,pPlayer->pos,pPlayer,pLocal));
}
if (FileLine==1)
{
DrawLine(512,0,(float)vvStart10.x,(float)vvEnd10.y,1,GREEN);
}
}}}}}}
if (pHealth->CurHP > 1)
{
if (ESPName==1)		{ 
DrawString(vvEnd10.x-10,vvEnd10.y-40,YELLOW,"  %s  ",pNames->szNames,pHealth->CurHP);}
}
...
if(YoWorlToScreenGa(pDevice,vEnd10,vvEnd10))
{
DrawLine(vvStart.x,vvStart.y,vvEnd.x,vvEnd.y,1,RED);//leher-kepala
DrawLine(vvStart2.x,vvStart2.y,vvEnd2.x,vvEnd2.y,1,YELLOW);//badan ampe kontol
DrawLine(vvStart3.x,vvStart3.y,vvEnd3.x,vvEnd3.y,1,GREEN);//tangan kiri
DrawLine(vvStart4.x,vvStart4.y,vvEnd4.x,vvEnd4.y,1,GREEN);//tangan kanan
//DrawLine(vvStart5.x,vvStart5.y,vvEnd5.x,vvEnd5.y,1,D3DCOLOR_ARGB(255, 0,   180, 255));//pinggul kiri
//DrawLine(vvStart6.x,vvStart6.y,vvEnd6.x,vvEnd6.y,1,D3DCOLOR_ARGB(255, 0,   180, 255));//pinggul kanan
